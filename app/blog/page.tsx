  ...
  const blogPosts = [
    {
      ...
      excerpt: "Public libraries are under constant pressure to provide reliable technology while also managing increasingly tight budgets. Linux offers a secure, cost-effective, and flexible alternative to Windows, allowing libraries to extend hardware life, reduce expenses, and improve system stability. With a modern, user-friendly interface and a full suite of free software, Linux gives patrons everything they need while aligning with the library’s mission of open access and digital literacy.",
